...
public class WebHostingPlan implements ServiceTreeItem {
    private boolean loading;
    private String name;
    private String webSpaceName;
    private String subscriptionId;

    public WebHostingPlan(@NotNull String name, @NotNull String webSpaceName, @NotNull String subscriptionId) {
        this.name = name;
